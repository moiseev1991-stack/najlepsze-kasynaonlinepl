...
export const megaMenuSections: MegaMenuSection[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { href: "/minimalny-depozyt/", label: "Minimalny depozyt" },
      { href: "/minimalny-depozyt/5zl/", label: "Kasyno 5 zł" },
      { href: "/minimalny-depozyt/10zl/", label: "Depozyt 10 zł" },
      { href: "/minimalny-depozyt/20zl/", label: "Kasyno 20 zł" },
